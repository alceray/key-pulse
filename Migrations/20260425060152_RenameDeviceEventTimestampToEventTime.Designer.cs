...
namespace KeyPulse.Migrations
{
    ...
    [Migration("20260425060152_RenameDeviceEventTimestampToEventTime")]
    partial class RenameDeviceEventTimestampToEventTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KeyPulse.Models.ActivitySnapshot", b =>
                {
                    ...
                    b.Property<byte>("MouseActiveSeconds")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KeyPulse.Models.Device", b =>
                {
                    ...
                    b.Property<TimeSpan>("TotalUsage")
                        .HasColumnType("TEXT");
